...
INSERT ALL
    INTO tbTiempo (lapsosTiempo, frecuenciaMedi)
         VALUES ('1 Vez al día', '')
    INTO tbTiempo (lapsosTiempo, frecuenciaMedi)
         VALUES ('2 Veces al día', '')
    INTO tbTiempo (lapsosTiempo, frecuenciaMedi)
         VALUES ('3 Veces al día', '')
    INTO tbTiempo (lapsosTiempo, frecuenciaMedi)
         VALUES ('4 Veces al día', '')
SELECT DUMMY FROM DUAL;
...
INSERT ALL
    INTO tbCitaMedica (ID_Cita, diaCita, horaCita, motivo, ID_Centro, ID_Paciente)
...
INSERT ALL
    INTO tbPaciente (ID_Paciente, nombrePaciente, apellidoPaciente, imgPaciete, parentesco, ID_Usuario)
